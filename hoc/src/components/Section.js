...
class Section extends React.Component {
    render() {
        return (
            <React.Fragment>
                <div /><h1>Hello WatchKit</h1>
                <div /><p>
                    Last month Apple released the anticipated WatchKit Framework 
                ...
                <div /><h1>Introduction to Swift</h1>
                <div /><p>Swift is a modern programming language developed by Apple to create the next 
